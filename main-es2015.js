...
module.exports = __webpack_require__(/*! D:\Projects\GitHub\WebPage\NotusAngular\src\main.ts */"zUnb");
...
let UserDropdownComponent = class UserDropdownComponent {
  ...
  <a href="#pablo" class="text-sm py-2 px-4 font-normal block w-full whitespace-no-wrap bg-transparent  text-gray-800">
    ...
    createPoppper() {
        new popper_js__WEBPACK_IMPORTED_MODULE_3__["default"](this.btnDropdownRef.nativeElement, this.popper, {
